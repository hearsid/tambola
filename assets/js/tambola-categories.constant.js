const tambolaCategories = [
    // 'Unlucky - Ab Hoga Nyay- Congress ✋🏽(2019)', 
    // 'Early 5 - Acche Beete 5 Saal, Lage Raho Kejriwal- AAP 🧹 (2019)',
    // 'Bamboo - Bidi Mein Tambaku Hai, Congress-Wala Daaku Hai- Bhartiya Jan Sangh 🕯️(1967)',
    // 'Corners - Hindu, Muslim, Sikh, Isaayi, Anna tere chaar sipahi. (Anna Hazare - 2011)',
    // 'Top Line - Bari Bari Sab Ki Bari, Ab Ki Bari Atal Bihari - Atal bihari 🌷(1996)',
    // 'Middle Lne - Mile Mulayam-Kanshiram, hawa ho gaye Jai Shree Ram - Mulayam Singh,SP 🚲-(1993)',
    // 'Bottom Line - Har Hindu Ki Yahi Pukar, Pehle Mandir Fir Sarkaar - Shiv Sena - Udhav Thakery⚔️ (2018)',
    // 'Full House - Abki Baar Modi Sarkar- BJP 2014🌷',
